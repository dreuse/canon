...
export const buildLightTheme = (input: ThemeOverride): DefaultTheme => {
  ...
  return {
    ...
    placeholder: "#a2b2c3",
    sidebarBackground: "hsl(60 9% 96% / 1)",
    sidebarHoverBackground: "hsl(60 9% 92% / 1)",
    sidebarActiveBackground: "hsl(60 9% 89% / 1)",
...
export const buildDarkTheme = (input: ThemeOverride): DefaultTheme => {
  ...
  return {
    ...
    sidebarHoverBackground: lighten(0.04, colors.veryDarkBlue),
    sidebarActiveBackground: lighten(0.07, colors.veryDarkBlue),
